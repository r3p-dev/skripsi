...
export default function ForgotPassword() {
  return (
    <AuthLayout
      ...
      description="Masukkan nomor telepon Anda untuk menerima tautan pemulihan dan mendapatkan kembali akses ke akun Anda dengan mudah dan aman."
      cardTitle="Lupa kata sandi"
      cardDescription="Masukkan nomor telepon Anda untuk menerima tautan reset kata sandi"
    >
      <div className="space-y-6">
        <Form route="password_reset.store" disableWhileProcessing resetOnSuccess>
          {({ errors, processing }) => (
            <FieldSet>
              <FieldGroup>
